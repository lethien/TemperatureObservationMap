...
$c_Lobservatory_Interaction2$.prototype.yearSelection__Lobservatory_Signal__Lobservatory_Signal__Lobservatory_Signal = (function(selectedLayer, sliderValue) {
  ...
  var expr = new $c_sjsr_AnonFunction0().init___sjs_js_Function0((function(sliderValue$1, bounds$1) {
    return (function() {
      return (($uI(sliderValue$1.apply__O()) < $as_sci_Range(bounds$1.apply__O()).head__I()) ? $as_sci_Range(bounds$1.apply__O()).head__I() : (($uI(sliderValue$1.apply__O()) > $as_sci_Range(bounds$1.apply__O()).last__I()) ? $as_sci_Range(bounds$1.apply__O()).last__I() : $uI(sliderValue$1.apply__O())))
    })
  })(sliderValue, bounds));
  return new $c_Lobservatory_Signal().init___F0(expr)
});
$c_Lobservatory_Interaction2$.prototype.availableLayers__sc_Seq = (function() {
  return $as_sc_Seq($m_sc_Seq$().apply__sc_Seq__sc_GenTraversable(new $c_sjs_js_WrappedArray().init___sjs_js_Array([new $c_Lobservatory_Layer().init___Lobservatory_LayerName__sc_Seq__sci_Range($m_Lobservatory_LayerName$Temperatures$(), $m_Lobservatory_package$TemperatureColorList$().temperatureColorList$1, new $c_sci_Range().init___I__I__I(1975, 2016, 1)), new $c_Lobservatory_Layer().init___Lobservatory_LayerName__sc_Seq__sci_Range($m_Lobservatory_LayerName$Deviations$(), $m_Lobservatory_package$TemperatureColorList$().deviationColorList$1, new $c_sci_Range().init___I__I__I(1990, 2016, 1))])))
});
$c_Lobservatory_Interaction2$.prototype.yearBounds__Lobservatory_Signal__Lobservatory_Signal = (function(selectedLayer) {
  $m_Lobservatory_Signal$();
  var expr = new $c_Lobservatory_Interaction2$$anonfun$yearBounds$1().init___Lobservatory_Signal(selectedLayer);
  return new $c_Lobservatory_Signal().init___F0(expr)
});
$c_Lobservatory_Interaction2$.prototype.layerUrlPattern__Lobservatory_Signal__Lobservatory_Signal__Lobservatory_Signal = (function(selectedLayer, selectedYear) {
  $m_Lobservatory_Signal$();
  var expr = new $c_sjsr_AnonFunction0().init___sjs_js_Function0((function(selectedLayer$2, selectedYear$1) {
    return (function() {
      return (((("target/" + $as_Lobservatory_Layer(selectedLayer$2.apply__O()).layerName$1.id$1) + "/") + $m_Lobservatory_Interaction2$().yearSelection__Lobservatory_Signal__Lobservatory_Signal__Lobservatory_Signal(selectedLayer$2, selectedYear$1).apply__O()) + "/{z}/{x}-{y}.png")
    })
...
$c_Lobservatory_Interaction2$.prototype.caption__Lobservatory_Signal__Lobservatory_Signal__Lobservatory_Signal = (function(selectedLayer, selectedYear) {
  ...
  var expr = new $c_sjsr_AnonFunction0().init___sjs_js_Function0((function(selectedLayer$3, selectedYear$2) {
    return (function() {
      ...
      var c = $s_sc_IndexedSeqOptimized$class__head__sc_IndexedSeqOptimized__O(this$2);
      if ((c === null)) {
        var c$1 = 0
      } else {
      ...
      var x$1 = $as_Lobservatory_Layer(selectedLayer$3.apply__O()).layerName$1.id$1;
      var this$10 = new $c_sci_StringOps().init___T(x$1);
      return ((((("" + jsx$1) + $as_T($s_sc_IndexedSeqOptimized$class__tail__sc_IndexedSeqOptimized__O(this$10))) + " (") + $m_Lobservatory_Interaction2$().yearSelection__Lobservatory_Signal__Lobservatory_Signal__Lobservatory_Signal(selectedLayer$3, selectedYear$2).apply__O()) + ")")
    })
  })(selectedLayer, selectedYear));
  return new $c_Lobservatory_Signal().init___F0(expr)
});
...
/** @constructor */
function $c_Lobservatory_package$TemperatureColorList$() {
  $c_O.call(this);
  this.white$1 = null;
  this.red$1 = null;
  this.yellow$1 = null;
  ...
  this.blue$1 = null;
  this.purple$1 = null;
  this.darkblue$1 = null;
  this.black$1 = null;
  this.temperatureColorList$1 = null;
  this.deviationColorList$1 = null
}
$c_Lobservatory_package$TemperatureColorList$.prototype = new $h_O();
$c_Lobservatory_package$TemperatureColorList$.prototype.constructor = $c_Lobservatory_package$TemperatureColorList$;
/** @constructor */
function $h_Lobservatory_package$TemperatureColorList$() {
  /*<skip>*/
}
$h_Lobservatory_package$TemperatureColorList$.prototype = $c_Lobservatory_package$TemperatureColorList$.prototype;
$c_Lobservatory_package$TemperatureColorList$.prototype.init___ = (function() {
  $n_Lobservatory_package$TemperatureColorList$ = this;
  this.white$1 = new $c_Lobservatory_Color().init___I__I__I(255, 255, 255);
  this.red$1 = new $c_Lobservatory_Color().init___I__I__I(255, 0, 0);
  this.yellow$1 = new $c_Lobservatory_Color().init___I__I__I(255, 255, 0);
  this.cyan$1 = new $c_Lobservatory_Color().init___I__I__I(0, 255, 255);
  this.blue$1 = new $c_Lobservatory_Color().init___I__I__I(0, 0, 255);
  this.purple$1 = new $c_Lobservatory_Color().init___I__I__I(255, 0, 255);
  this.darkblue$1 = new $c_Lobservatory_Color().init___I__I__I(33, 0, 107);
  this.black$1 = new $c_Lobservatory_Color().init___I__I__I(0, 0, 0);
  $m_sci_List$();
  var xs = new $c_sjs_js_WrappedArray().init___sjs_js_Array([new $c_T2().init___O__O((-60.0), this.black$1), new $c_T2().init___O__O((-50.0), this.darkblue$1), new $c_T2().init___O__O((-27.0), this.purple$1), new $c_T2().init___O__O((-15.0), this.blue$1), new $c_T2().init___O__O(0.0, this.cyan$1), new $c_T2().init___O__O(12.0, this.yellow$1), new $c_T2().init___O__O(32.0, this.red$1), new $c_T2().init___O__O(60.0, this.white$1)]);
  var this$2 = $m_sci_List$();
  var cbf = this$2.ReusableCBFInstance$2;
  this.temperatureColorList$1 = $as_sci_List($s_sc_TraversableLike$class__to__sc_TraversableLike__scg_CanBuildFrom__O(xs, cbf));
  $m_sci_List$();
  var xs$1 = new $c_sjs_js_WrappedArray().init___sjs_js_Array([new $c_T2().init___O__O((-7.0), this.blue$1), new $c_T2().init___O__O((-2.0), this.cyan$1), new $c_T2().init___O__O(0.0, this.white$1), new $c_T2().init___O__O(2.0, this.yellow$1), new $c_T2().init___O__O(4.0, this.red$1), new $c_T2().init___O__O(7.0, this.black$1)]);
  var this$4 = $m_sci_List$();
  var cbf$1 = this$4.ReusableCBFInstance$2;
  this.deviationColorList$1 = $as_sci_List($s_sc_TraversableLike$class__to__sc_TraversableLike__scg_CanBuildFrom__O(xs$1, cbf$1));
  return this
});
var $d_Lobservatory_package$TemperatureColorList$ = new $TypeData().initClass({
  Lobservatory_package$TemperatureColorList$: 0
}, false, "observatory.package$TemperatureColorList$", {
  Lobservatory_package$TemperatureColorList$: 1,
  O: 1
});
$c_Lobservatory_package$TemperatureColorList$.prototype.$classData = $d_Lobservatory_package$TemperatureColorList$;
var $n_Lobservatory_package$TemperatureColorList$ = (void 0);
function $m_Lobservatory_package$TemperatureColorList$() {
  if ((!$n_Lobservatory_package$TemperatureColorList$)) {
    $n_Lobservatory_package$TemperatureColorList$ = new $c_Lobservatory_package$TemperatureColorList$().init___()
  };
  return $n_Lobservatory_package$TemperatureColorList$
}
/** @constructor */
...
/** @constructor */
function $c_Lobservatory_Interaction2$$anonfun$yearBounds$1() {
  $c_sr_AbstractFunction0.call(this);
  this.selectedLayer$1$f = null
}
$c_Lobservatory_Interaction2$$anonfun$yearBounds$1.prototype = new $h_sr_AbstractFunction0();
$c_Lobservatory_Interaction2$$anonfun$yearBounds$1.prototype.constructor = $c_Lobservatory_Interaction2$$anonfun$yearBounds$1;
/** @constructor */
function $h_Lobservatory_Interaction2$$anonfun$yearBounds$1() {
  /*<skip>*/
}
$h_Lobservatory_Interaction2$$anonfun$yearBounds$1.prototype = $c_Lobservatory_Interaction2$$anonfun$yearBounds$1.prototype;
$c_Lobservatory_Interaction2$$anonfun$yearBounds$1.prototype.init___Lobservatory_Signal = (function(selectedLayer$1) {
  this.selectedLayer$1$f = selectedLayer$1;
  return this
});
$c_Lobservatory_Interaction2$$anonfun$yearBounds$1.prototype.apply__O = (function() {
  return this.apply__sci_Range()
});
$c_Lobservatory_Interaction2$$anonfun$yearBounds$1.prototype.apply__sci_Range = (function() {
  return $as_Lobservatory_Layer($m_Lobservatory_Interaction2$().availableLayers__sc_Seq().find__F1__s_Option(new $c_sjsr_AnonFunction1().init___sjs_js_Function1((function(arg$outer) {
    return (function(layer$2) {
      var layer = $as_Lobservatory_Layer(layer$2);
      var this$1 = layer.layerName$1.id$1;
      var that = $as_Lobservatory_Layer(arg$outer.selectedLayer$1$f.apply__O()).layerName$1.id$1;
      return (this$1 === that)
    })
  })(this))).get__O()).bounds$1
});
var $d_Lobservatory_Interaction2$$anonfun$yearBounds$1 = new $TypeData().initClass({
  Lobservatory_Interaction2$$anonfun$yearBounds$1: 0
}, false, "observatory.Interaction2$$anonfun$yearBounds$1", {
  Lobservatory_Interaction2$$anonfun$yearBounds$1: 1,
  sr_AbstractFunction0: 1,
  O: 1,
  F0: 1,
  s_Serializable: 1,
...
$c_Lobservatory_Interaction2$$anonfun$yearBounds$1.prototype.$classData = $d_Lobservatory_Interaction2$$anonfun$yearBounds$1;
/** @constructor */
